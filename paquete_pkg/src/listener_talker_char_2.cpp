...
int main(int argc, char **argv)
{
  ...
  ros::init(argc, argv, "listener_talker_char_2"); // inicializacion del nodo F
  ros::NodeHandle n;
//-------------------------------------------------------------------------------------------
//el nodo F se suscribe al topic "string_int" del nodo C
  ros::Subscriber sub = n.subscribe("string_int", 1000, chatterCallback);
//-------------------------------------------------------------------------------------------
//publica el topic "char_int" que contiene el caracter que indica la decision (Alto, medio, bajo)
  ros::Publisher char_pub = n.advertise<std_msgs::Char>("char_int", 1000); 
//-------------------------------------------------------------------------------------------
