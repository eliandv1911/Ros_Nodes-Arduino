...
int main(int argc, char **argv)
{
  ...
  ros::init(argc, argv, "listener_talker_char_3"); // inicializacion del nodo G
  ros::NodeHandle n;
//-------------------------------------------------------------------------------------------
//el nodo G se suscribe al topic "string_float" del nodo D
  ros::Subscriber sub = n.subscribe("string_float", 1000, chatterCallback);
//-------------------------------------------------------------------------------------------
//publica el topic "char_float" que contiene el caracter que indica la decision (Alto, medio, bajo)
  ros::Publisher char_pub = n.advertise<std_msgs::Char>("char_float", 1000); 
//-------------------------------------------------------------------------------------------
